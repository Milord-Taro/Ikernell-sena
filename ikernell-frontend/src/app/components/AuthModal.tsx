...
import { X, Eye, EyeOff, Code2, ArrowRight, Github, Chrome } from "lucide-react";
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-0.5">
                  {isSignUp ? "Comienza tu prueba gratuita de 30 días" : "Ingresa a tu cuenta IKernell"}
                </p>
              </div>
            </div>
            <button
            ...
            {isSignUp && (
              <div className="flex items-start gap-2.5 pt-1">
                <input
                  ...
                  aria-required="true"
                />
                <label htmlFor="auth-terms" className="text-xs text-slate-600 leading-relaxed">
                  Acepto los{" "}
